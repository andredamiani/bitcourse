...
_d = 947 = 2^0^ +++<u>+</u>+++ 2^1^ +++<u>+</u>+++ 2^4^ +++<u>+</u>+++ 2^5^ +++<u>+</u>+++ 2^7^ +++<u>+</u>+++ 2^8^ +++<u>+</u>+++ 2^*9*^_ +
_947P = P + 2P + 16P + 32P + 128P + 256P + 512P_

*9* doubling e +++<u>6</u>+++ addition: polinomiale nel numero di bit di _d_ e decisamente migliore di 946 addizioni
